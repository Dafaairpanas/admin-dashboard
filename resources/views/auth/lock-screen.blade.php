...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body pt-0">
            <form class="my-4" action="{{ url('/dashboard') }}">
                ...
                <div class="form-group mb-0 row">
                    <div class="col-12">
                        <div class="d-grid mt-3">
                            <button class="btn btn-primary" type="button">Unlock <i
            ...
            <div class="text-center  mb-2">
                {{-- <p class="text-muted">Not you ? return <a href="{{ route('second', ['auth', 'register'])}}"
