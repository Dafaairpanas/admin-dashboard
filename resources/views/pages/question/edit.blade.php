...
@section('content')
            ...
            <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                ...
                <div class="">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('QUESTIONS.read') }}">Questions</a></li>
    ...
    <form action="{{ $question ? route('QUESTIONS.update.save', $question->id) : route('QUESTIONS.create.save') }}" method="POST">
        @csrf
        @if($question)
            @method('PUT')
        @endif
        ...
        <div class="row">
            ...
            <div class="col-lg-12 mb-4">
                ...
                <a href="{{ route('QUESTIONS.read') }}" class="btn btn-secondary ms-2">Cancel</a>
            </div>
        </div>
    </form>
